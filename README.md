# SeleniumGridScaler [![Build Status](https://travis-ci.org/strataconsulting/SeleniumGridScaler.svg?branch=master)](https://travis-ci.org/strataconsulting/SeleniumGridScaler)
